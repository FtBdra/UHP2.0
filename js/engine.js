...
// ─── Presets ─────────────────────────────────────────────────
const PRESETS = {
  elite:     { rev: 20000000, exp: 13000000, trx: 160, tenure: 90,  repeatorder: 65, review: 'Pelayanan cepat dan ramah, pesanan selalu tepat. Aplikasi pemesanan mudah dipakai dan responsif. Kualitas produk konsisten.' },
  growth:    { rev: 8000000,  exp: 6500000,  trx: 120, tenure: 36,  repeatorder: 35, review: 'Harga dan kualitas seimbang, pengalaman biasa saja. Pelayanan standar, masih bisa ditingkatkan.' },
  struggling:{ rev: 5000000,  exp: 5400000,  trx: 80,  tenure: 18,  repeatorder: 20, review: 'Kadang stok kosong saat jam ramai. Secara umum oke, hanya respon chat kadang lambat.' },
  critical:  { rev: 2000000,  exp: 3000000,  trx: 25,  tenure: 4,   repeatorder: 5,  review: 'Respons admin lambat dan informasi kurang jelas. Harga naik tapi layanan tidak membaik. Pesanan sering terlambat.' },
};
